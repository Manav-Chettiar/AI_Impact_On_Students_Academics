...
This project explores how Generative AI (GenAI) usage affects student academic performance, burnout, and study habits. Built as a two-page interactive Power BI dashboard with a cover page, KPI cards, and a range of different visuals. jhfkfkwr2iuabkj
